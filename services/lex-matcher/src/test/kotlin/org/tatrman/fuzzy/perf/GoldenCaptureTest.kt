 ...
 *
 *   ./gradlew :services:lex-matcher:test --tests '*GoldenCaptureTest*' -DregenGoldens=true
 */
...
internal fun resolveGoldenFile(): File {
    val moduleDir =
        when {
            ...
            File("services/lex-matcher/src/test/resources").isDirectory -> File("services/lex-matcher")
            else -> File(".")
        }
