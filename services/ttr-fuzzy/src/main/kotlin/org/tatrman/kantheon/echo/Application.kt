...
import org.tatrman.kantheon.echo.api.GrpcService
import org.tatrman.kantheon.echo.api.configureRoutes
import org.tatrman.kantheon.echo.config.ConfigLoader
import org.tatrman.kantheon.echo.core.Candidate
import org.tatrman.kantheon.echo.core.EchoMatcher
import org.tatrman.kantheon.echo.core.Lemmatizer
import org.tatrman.kantheon.echo.core.NoopLemmatizer
import org.tatrman.kantheon.echo.core.StringRepository
import org.tatrman.kantheon.echo.db.DatabaseFactory
import org.tatrman.kantheon.echo.loader.EchoCatalog
import org.tatrman.kantheon.echo.loader.LoaderSource
import org.tatrman.kantheon.echo.loader.MetadataLoaderSource
import org.tatrman.kantheon.echo.loader.MetadataServiceClient
import org.tatrman.kantheon.echo.loader.StaticLoaderSource
...
private val log = LoggerFactory.getLogger("org.tatrman.kantheon.echo.Application")
...
fun Application.module(serverConfig: KtorServerConfig) {
    ...
    val lemmatizer: Lemmatizer =
        if (nlpHttpClient != null) {
            ...
            org.tatrman.kantheon.echo.core
