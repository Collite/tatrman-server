...
import org.tatrman.ariadne.v1.AttributeDetail
import org.tatrman.ariadne.v1.AttributeJoinPair
import org.tatrman.ariadne.v1.Binding as BindingProto
import org.tatrman.ariadne.v1.BindingType
import org.tatrman.ariadne.v1.Cardinality
import org.tatrman.ariadne.v1.DbColumnDetail
import org.tatrman.ariadne.v1.DbColumnSummary
import org.tatrman.ariadne.v1.DbForeignKeyDetail
import org.tatrman.ariadne.v1.DbTableDetail
import org.tatrman.ariadne.v1.DbViewDetail
import org.tatrman.ariadne.v1.DrillMapDetail
import org.tatrman.ariadne.v1.ModelBundleAttribute
...
import org.tatrman.ariadne.v1.Er2CncRoleMappingDetail
import org.tatrman.ariadne.v1.EdgeResult
import org.tatrman.ariadne.v1.RefreshRequest
import org.tatrman.ariadne.v1.RefreshResponse
import org.tatrman.ariadne.v1.ResolveAreaRequest
import org.tatrman.ariadne.v1.ResolveAreaResponse
import org.tatrman.ariadne.v1.SourceRefreshResult
import org.tatrman.ariadne.v1.Er2DbAttributeMappingDetail
import org.tatrman.ariadne.v1.Er2DbEntityMappingDetail
import org.tatrman.ariadne.v1.Er2DbRelationMappingDetail
import org.tatrman.ariadne.v1.TraverseEdgesRequest
import org.tatrman.ariadne.v1.TraverseEdgesResponse
...
import org.tatrman.ariadne.v1.GetStatusResponse
import org.tatrman.ariadne.v1.Language as ProtoLanguage
...
import org.tatrman.ariadne.v1.ModelBundleTable
import org.tatrman.ariadne.v1.ModelBundleView
import org.tatrman.ariadne.v1.PackageVersion
import org.tatrman.ariadne.v1.RelationDetail
import org.tatrman.ariadne.v1.RoleEntry
import org.tatrman.ariadne.v1.LocalizedString as ProtoLocalizedString
import org.tatrman.ariadne.v1.LocalizedStringList as ProtoLocalizedStringList
import org.tatrman.ariadne.v1.AriadneServiceGrpcKt
import org.tatrman.ariadne.v1.SearchHints as ProtoSearchHints
import org.tatrman.ariadne.v1.SearchRequest
import org.tatrman.ariadne.v1.SearchResponse
import org.tatrman.ariadne.v1.SearchResult
import org.tatrman.ariadne.v1.StringList as ProtoStringList
import org.tatrman.ariadne.v1.ModelDescriptor as ProtoModelDescriptor
...
import org.tatrman.ariadne.v1.PageInfo
...
import org.tatrman.ariadne.v1.QueryDetail
import org.tatrman.ariadne.v1.QueryParameterDef as ProtoQueryParameterDef
import org.tatrman.kantheon.common.v1.ResponseMessage
import org.tatrman.ariadne.v1.RoleDetail
 ...
 * live from the background [org.tatrman.kantheon.ariadne.parse.QueryParseWorker]; otherwise they reflect the
...
class MetadataServiceImpl(
    ...
    override suspend fun getSnapshot(request: GetSnapshotRequest): GetSnapshotResponse {
        ...
        val snapshotBuilder =
            org.tatrman.ariadne.v1.ModelSnapshot
                .newBuilder()
                .setModel(descriptor)
        ...
        searchIndexHolder?.stats()?.let { stats ->
            ...
            stats.compileErrors.take(MAX_COMPILE_ERRORS_SURFACED).forEach { ce ->
                builder.addSearchCompileErrors(
                    org.tatrman.ariadne.v1.CompileError
                        .newBuilder()
                        .setField(ce.field)
...
private fun Query.toModelBundleQuery(
    ...
    for (param in parameters) {
        builder.addParameters(
            org.tatrman.ariadne.v1.QueryParameterDef
                .newBuilder()
                .setName(param.name)
                .setType(param.type)
