...
class GroundingModelHandle(
    ...
    override fun currentVersion(): String = "money-roundtrip-v0"
    ...
    companion object {
        ...
        /** Fact `Sale(amount, amount_dom, currency, date)` + `FxRate(rate, from/to ccy, validity)`. */
        fun moneyModel(): GroundingModelHandle =
                ...
                listOf(
                    dbTable(
                        ...
                        listOf(
                            ...
                            "amount_dom" to SurfaceType.FLOAT,
                            "currency" to SurfaceType.TEXT,
                            "date" to SurfaceType.DATETIME,
                        ),
                    ),
                    dbTable(
                        "FxRate",
                        listOf(
                            ...
                            "from_ccy" to SurfaceType.TEXT,
                            "to_ccy" to SurfaceType.TEXT,
                            "valid_from" to SurfaceType.DATETIME,
                            "valid_to" to SurfaceType.DATETIME,
                        ),
                    ),
                ),
            )
