...
/**
 * Thin client over `infra/llm-gateway`'s `POST /api/v1/chat/responses` endpoint. money uses this
 * as the below-threshold fallback (A10.6): the prompt returns the SAME GroundingResult JSON schema,
