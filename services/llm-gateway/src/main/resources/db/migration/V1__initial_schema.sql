...
GRANT ALL PRIVILEGES ON TABLE prompt_logs TO "${appRole}";
GRANT USAGE, SELECT ON SEQUENCE prompt_logs_id_seq TO "${appRole}";
...
GRANT ALL PRIVILEGES ON TABLE jobs TO "${appRole}";
