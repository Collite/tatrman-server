...
Self-test (runs in the PR lane, `just test-kt :services:llm-gateway` → `ContractDiffSpec`):
...
1. Start 1.x locally: `./gradlew :services:llm-gateway:bootRun` (pre-rewrite tree, tag
