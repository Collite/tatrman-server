package org.tatrman.kantheon.argos.grpc
...
import org.tatrman.argos.v1.ArgosServiceGrpcKt
...
import org.tatrman.kantheon.argos.roles.RoleSourceUnavailableException
import org.tatrman.kantheon.argos.stages.LlmGuard
import org.tatrman.kantheon.argos.stages.MixedLayerDetector
...
class ArgosServiceImpl(
    ...
    override suspend fun validate(request: ValidateRequest): ValidateResponse {
        ...
        val applied = mutableListOf<org.tatrman.argos.v1.SecurityRuleApplied>()
