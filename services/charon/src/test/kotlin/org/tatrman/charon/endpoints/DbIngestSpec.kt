...
package org.tatrman.charon.endpoints

import org.tatrman.charon.core.ArrowPipe
import org.tatrman.charon.core.DbWritePreconditionException
import org.tatrman.charon.core.Either
import org.tatrman.charon.core.HikariConnectionProvider
import org.tatrman.charon.core.Integrity
import org.tatrman.charon.core.LocationKind
import org.tatrman.charon.core.MoveRpc
import org.tatrman.charon.core.PipeOptions
import org.tatrman.charon.core.Source
...
class DbIngestSpec :
    StringSpec({
        ...
        fun ingest(
            handle: org.tatrman.charon.core.ConnectionHandle,
            table: String,
            mode: DbWriteMode,
            rows: List<Pair<Long, String?>>,
        ): Either<org.tatrman.charon.core.CharonError, MoveResult> {
        ...
        "a mid-commit constraint fault rolls the whole transaction back (no partial write)" {
            ...
            r.shouldBeInstanceOf<Either.Left<org.tatrman.charon.core.CharonError>>()
