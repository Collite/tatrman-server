package cz.tatrman.charon.endpoints

import cz.tatrman.charon.core.ArrowPipe
import cz.tatrman.charon.core.DbWritePreconditionException
import cz.tatrman.charon.core.Either
import cz.tatrman.charon.core.HikariConnectionProvider
import cz.tatrman.charon.core.Integrity
import cz.tatrman.charon.core.LocationKind
import cz.tatrman.charon.core.MoveRpc
import cz.tatrman.charon.core.PipeOptions
import cz.tatrman.charon.core.Source
...
class DbIngestSpec :
    StringSpec({
        ...
        fun ingest(
            handle: cz.tatrman.charon.core.ConnectionHandle,
            table: String,
            mode: DbWriteMode,
            rows: List<Pair<Long, String?>>,
        ): Either<cz.tatrman.charon.core.CharonError, MoveResult> {
        ...
        "a mid-commit constraint fault rolls the whole transaction back (no partial write)" {
            ...
            r.shouldBeInstanceOf<Either.Left<cz.tatrman.charon.core.CharonError>>()
