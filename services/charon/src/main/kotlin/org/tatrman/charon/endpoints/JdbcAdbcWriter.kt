...
import org.tatrman.charon.core.AdbcWriter
import org.tatrman.charon.core.ConnectionHandle
import org.tatrman.charon.core.DbConnectionProvider
import org.tatrman.charon.core.DbTypeMapping
import org.tatrman.charon.core.DbWritePreconditionException
import org.tatrman.charon.core.LocationKind
import org.tatrman.charon.core.Target
...
class JdbcAdbcWriter(
    ...
    private fun prepareInsert(
        ...
        qualified: String,
        schema: Schema,
        dialect: org.tatrman.charon.core.DbDialect,
    ): PreparedStatement {
