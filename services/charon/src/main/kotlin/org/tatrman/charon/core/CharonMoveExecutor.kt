...
import org.tatrman.charon.endpoints.JdbcAdbcReader
import org.tatrman.charon.endpoints.JdbcAdbcWriter
import org.tatrman.charon.endpoints.LettuceRedisOps
import org.tatrman.charon.endpoints.RedisEndpoint
import org.tatrman.charon.endpoints.RedisOps
import org.tatrman.charon.endpoints.SeaweedEndpoint
import org.tatrman.charon.endpoints.WorkerEndpoint
...
class CharonMoveExecutor(
    ...
    private fun pipeWithOptions(
        ...
        source: org.tatrman.charon.core.Source,
        target: org.tatrman.charon.core.Target,
    ): Either<CharonError, MoveResult> {
        val options =
            PipeOptions(
