...
package org.tatrman.charon.grpc

import org.tatrman.charon.core.CharonError
import org.tatrman.charon.core.Either
import org.tatrman.charon.core.MoveExecutor
import org.tatrman.charon.core.MovePlanner
import org.tatrman.charon.core.Planned
import org.tatrman.charon.core.toResponseMessage
import org.tatrman.charon.core.toStatus
...
class CharonServiceImpl(
    ...
    private fun handle(
        ...
        planned: Planned,
        responseObserver: StreamObserver<MoveResult>,
        execute: (org.tatrman.charon.core.Plan) -> Either<CharonError, MoveResult>,
    ) {
        when (planned) {
            is Planned.Invalid -> {
 ...
 * [RESPONSE_MESSAGES_TRAILER_KEY] + `MessageParser<org.tatrman.common.v1.ResponseMessage>`.
 */
