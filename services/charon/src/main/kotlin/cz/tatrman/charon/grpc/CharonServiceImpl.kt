package cz.tatrman.charon.grpc

import cz.tatrman.charon.core.CharonError
import cz.tatrman.charon.core.Either
import cz.tatrman.charon.core.MoveExecutor
import cz.tatrman.charon.core.MovePlanner
import cz.tatrman.charon.core.Planned
import cz.tatrman.charon.core.toResponseMessage
import cz.tatrman.charon.core.toStatus
...
class CharonServiceImpl(
    ...
    private fun handle(
        ...
        planned: Planned,
        responseObserver: StreamObserver<MoveResult>,
        execute: (cz.tatrman.charon.core.Plan) -> Either<CharonError, MoveResult>,
    ) {
        when (planned) {
            is Planned.Invalid -> {
 ...
 * [RESPONSE_MESSAGES_TRAILER_KEY] + `MessageParser<cz.tatrman.common.v1.ResponseMessage>`.
 */
