...
import cz.tatrman.charon.core.AdbcWriter
import cz.tatrman.charon.core.ConnectionHandle
import cz.tatrman.charon.core.DbConnectionProvider
import cz.tatrman.charon.core.DbTypeMapping
import cz.tatrman.charon.core.DbWritePreconditionException
import cz.tatrman.charon.core.LocationKind
import cz.tatrman.charon.core.Target
...
class JdbcAdbcWriter(
    ...
    private fun prepareInsert(
        ...
        qualified: String,
        schema: Schema,
        dialect: cz.tatrman.charon.core.DbDialect,
    ): PreparedStatement {
