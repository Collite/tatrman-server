...
import cz.tatrman.charon.endpoints.JdbcAdbcReader
import cz.tatrman.charon.endpoints.JdbcAdbcWriter
import cz.tatrman.charon.endpoints.LettuceRedisOps
import cz.tatrman.charon.endpoints.RedisEndpoint
import cz.tatrman.charon.endpoints.RedisOps
import cz.tatrman.charon.endpoints.SeaweedEndpoint
import cz.tatrman.charon.endpoints.WorkerEndpoint
...
class CharonMoveExecutor(
    ...
    private fun pipeWithOptions(
        ...
        source: cz.tatrman.charon.core.Source,
        target: cz.tatrman.charon.core.Target,
    ): Either<CharonError, MoveResult> {
        val options =
            PipeOptions(
