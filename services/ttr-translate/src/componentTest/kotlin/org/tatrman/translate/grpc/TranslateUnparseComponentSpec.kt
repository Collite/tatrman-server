 ...
 * emitted PostgreSQL to golden files under `src/componentTest/resources/translate/`. An exact-match
 ...
 * (`RECORD_GOLDEN=1 ./gradlew :services:ttr-translate:componentTest`) after a deliberate, reviewed
 ...
 */
@Tags("component")
class TranslateUnparseComponentSpec :
    StringSpec({
        ...
        fun assertGolden(
            ...
            val golden =
                TranslateUnparseComponentSpec::class.java.classLoader
