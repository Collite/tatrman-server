            ...
            for (entry in snapshot.objectsList) {
                ...
                when (entry.contentCase) {
                    ...
                    ObjectEntry.ContentCase.ER2DB_ENTITY_MAPPING -> {
                        val mapping =
                            when (entry.er2DbEntityMapping.targetCase) {
                                org.tatrman.ariadne.v1.Er2DbEntityMappingDetail.TargetCase.TABLE ->
                                ...
                                org.tatrman.ariadne.v1.Er2DbEntityMappingDetail.TargetCase.VIEW ->
                                    EntityMapping.ToTable(
                                ...
                                org.tatrman.ariadne.v1.Er2DbEntityMappingDetail.TargetCase.SQL_QUERY ->
                    ...
                    ObjectEntry.ContentCase.ER2DB_ATTRIBUTE_MAPPING -> {
                        ...
                        if (targetCase == org.tatrman.ariadne.v1.Er2DbAttributeMappingDetail.TargetCase.COLUMN) {
