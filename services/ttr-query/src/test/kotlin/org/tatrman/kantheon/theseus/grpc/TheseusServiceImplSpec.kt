            ...
            runBlocking {
                ...
                val dbDetectStub =
                    TranslatorDetectClient {
                        DetectSchemaResponse
                            .newBuilder()
                            .setDecision(org.tatrman.proteus.v1.SchemaDecision.AUTODETECTED)
                            .setEffectiveSchema(org.tatrman.plan.v1.SchemaCode.DB)
                            .addMessages(
                                ResponseMessage
                                    .newBuilder()
            ...
            runBlocking {
                val correctedDetectStub =
                    TranslatorDetectClient {
                        DetectSchemaResponse
                            .newBuilder()
                            .setDecision(org.tatrman.proteus.v1.SchemaDecision.CORRECTED)
                            .setEffectiveSchema(org.tatrman.plan.v1.SchemaCode.DB)
                            .addMessages(
                                ResponseMessage
                                    .newBuilder()
            ...
            runBlocking {
                ...
                val ambiguousDetectStub =
                    TranslatorDetectClient {
                        DetectSchemaResponse
                            .newBuilder()
                            .setDecision(org.tatrman.proteus.v1.SchemaDecision.AMBIGUOUS)
            ...
            runBlocking {
                ...
                val unknownDetectStub =
                    TranslatorDetectClient {
                        DetectSchemaResponse
                            .newBuilder()
                            .setDecision(org.tatrman.proteus.v1.SchemaDecision.UNKNOWN)
                            .setEffectiveSchema(org.tatrman.plan.v1.SchemaCode.SCHEMA_CODE_UNSPECIFIED)
                            .addMessages(
                                ResponseMessage
                                    .newBuilder()
            ...
            runBlocking {
                ...
                val mixedDetectStub =
                    TranslatorDetectClient {
                        DetectSchemaResponse
                            .newBuilder()
                            .setDecision(org.tatrman.proteus.v1.SchemaDecision.MIXED)
                            .setEffectiveSchema(org.tatrman.plan.v1.SchemaCode.SCHEMA_CODE_UNSPECIFIED)
                            .addMessages(
                                ResponseMessage
                                    .newBuilder()
            ...
            runBlocking {
                ...
                val naDetectStub =
                    TranslatorDetectClient {
                        DetectSchemaResponse
                            .newBuilder()
                            .setDecision(org.tatrman.proteus.v1.SchemaDecision.NOT_APPLICABLE)
                            .setEffectiveSchema(org.tatrman.plan.v1.SchemaCode.SCHEMA_CODE_UNSPECIFIED)
                            .build()
                    }
                val countingParseStub =
