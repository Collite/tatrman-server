package org.tatrman.kantheon.theseus
...
import org.tatrman.kantheon.theseus.client.GrpcDispatcherClient
import org.tatrman.kantheon.theseus.client.GrpcTranslatorClient
import org.tatrman.kantheon.theseus.client.GrpcValidatorClient
...
private val log = LoggerFactory.getLogger("org.tatrman.kantheon.theseus.Application")
...
private fun pickTranslatorClient(
    ...
    if (useFixture) {
        ...
        return object : TranslatorClient, TranslatorDetectClient, TranslatorTranslateClient {
            override suspend fun parse(request: org.tatrman.proteus.v1.ParseRequest) =
            ...
            override suspend fun translate(request: org.tatrman.proteus.v1.TranslateRequest) =
                org.tatrman.proteus.v1
                    .TranslateResponse
                    .newBuilder()
                    .setContext(request.context)
            ...
            override suspend fun detect(request: org.tatrman.proteus.v1.DetectSchemaRequest) =
                org.tatrman.proteus.v1
                    .DetectSchemaResponse
                    .newBuilder()
                    .setDecision(org.tatrman.proteus.v1.SchemaDecision.SCHEMA_DECISION_UNSPECIFIED)
