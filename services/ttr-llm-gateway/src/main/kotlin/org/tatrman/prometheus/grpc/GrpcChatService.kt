package org.tatrman.prometheus.grpc

import io.grpc.stub.StreamObserver
import org.springframework.stereotype.Service
import org.tatrman.prometheus.v1.*
import org.tatrman.prometheus.web.*
                ...
                if (!out.toolCalls.isNullOrEmpty()) {
                    val protoToolCalls =
                        out.toolCalls.map { tc ->
                            org.tatrman.prometheus.v1.ToolCall
                                .newBuilder()
                                .setId(tc.id)
                                .setType(tc.type)
                                .setFunction(
                                    org.tatrman.prometheus.v1.FunctionCall
                                        .newBuilder()
