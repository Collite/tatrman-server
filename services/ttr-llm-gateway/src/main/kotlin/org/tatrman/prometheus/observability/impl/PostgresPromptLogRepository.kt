package org.tatrman.prometheus.observability.impl

import org.springframework.boot.autoconfigure.condition.ConditionalOnProperty
import org.springframework.jdbc.core.JdbcTemplate
import org.springframework.stereotype.Repository
import org.tatrman.prometheus.observability.PromptLog
import org.tatrman.prometheus.observability.PromptLogRepository

@Repository
@ConditionalOnProperty(name = ["llm.storage.type"], havingValue = "postgres")
class PostgresPromptLogRepository(
