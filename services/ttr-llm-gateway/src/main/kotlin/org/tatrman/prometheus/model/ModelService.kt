...
import org.tatrman.prometheus.observability.PromptLog
import org.tatrman.prometheus.web.ChatCompletionRequestApi
import org.tatrman.prometheus.web.ChatCompletionResponseApi
import org.tatrman.prometheus.web.ChatMessageApi
import org.tatrman.prometheus.web.ChoiceApi
import org.tatrman.prometheus.web.ResponseOutputApi
import org.tatrman.prometheus.web.UsageApi
import org.tatrman.prometheus.web.toSpringAiMessage
...
class ModelService(
    ...
    private val chatResponseCache: org.tatrman.prometheus.cache.ChatResponseCache? = null,
            ...
            val toolCallsApi =
                if (assistantMsg is org.springframework.ai.chat.messages.AssistantMessage &&
                    ...
                    assistantMsg.toolCalls.map { tc ->
                        org.tatrman.prometheus.web.ToolCallApi(
                            id = tc.id(),
                            type = tc.type(),
                            function =
                                org.tatrman.prometheus.web.FunctionCallApi(
                                    name = tc.name(),
