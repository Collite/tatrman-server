package org.tatrman.kantheon.arges.grpc
...
class WorkerServiceImpl(
    ...
    override suspend fun getCapabilities(request: GetCapabilitiesRequest): GetCapabilitiesResponse {
        // Advertise the engine-side database + default schema for each configured connection_id,
        // so the dispatcher can concretize logical TableScan qnames before forwarding the SQL.
        val connectionInfos =
        ...
        return GetCapabilitiesResponse
            ...
            .addAllSupportedDialects(listOf("POSTGRESQL"))
