...
In short: **edges** (workers, connectors, plugins) land through PR + review +
conformance; **core** (service contracts, the MCP surface, the plan wire format)
goes through the public RFC process. See [CONTRIBUTING.md](./CONTRIBUTING.md).
