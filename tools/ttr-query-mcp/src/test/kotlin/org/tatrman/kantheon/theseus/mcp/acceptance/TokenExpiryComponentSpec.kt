package org.tatrman.kantheon.theseus.mcp.acceptance
...
import org.tatrman.kantheon.theseus.mcp.identity.IdentityGate
            ...
            runBlocking {
                ...
                val identity =
                    UserIdentity(
                        id = "alice",
                        roles = setOf("analyst"),
                        source = org.tatrman.kantheon.theseus.mcp.identity.IdentitySource.TOKEN,
                    )
