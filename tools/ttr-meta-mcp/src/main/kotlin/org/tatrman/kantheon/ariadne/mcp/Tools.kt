...
class Tools(
    ...
    private fun notFoundResult(
        toolName: String,
        id: String,
        messages: List<org.tatrman.kantheon.common.v1.ResponseMessage>,
    ): CallToolResult {
...
private fun encodeBundleQueriesJson(
    queries: List<org.tatrman.ariadne.v1.ModelBundleQuery>,
    knownPackages: Collection<String>,
...
private fun encodeQueryDescriptorsJson(
    queries: List<org.tatrman.ariadne.v1.QueryDescriptor>,
): kotlinx.serialization.json.JsonArray =
    buildJsonArray {
        for (query in queries) {
            val obj = query.objectDescriptor
...
private fun encodeQueryDetailJson(
    resp: org.tatrman.ariadne.v1.GetQueryResponse,
