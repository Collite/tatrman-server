...
class FuzzyMcpTelemetry {
    ...
    init {
        ...
        val protocol = System.getenv("FUZZY_MCP_OTEL_PROTOCOL") ?: "grpc"
        openTelemetry =
            createOpenTelemetrySdk(
                OtelEndpointConfig(serviceName = "fuzzy-mcp", protocol = protocol),
                enabled = enabled,
            )
        tracer = openTelemetry.getTracer("fuzzy-mcp")
    }
}
