package org.tatrman.testkit.containers
...
object Containers {
     ...
     * [org.tatrman.testkit.CiOnly]; see plan.md Stage 1.2 T3 + the Mac
    ...
    /** Empty WireMock — fixtures are pushed at runtime via [org.tatrman.testkit.wiremock.WireMockAdmin]. */
